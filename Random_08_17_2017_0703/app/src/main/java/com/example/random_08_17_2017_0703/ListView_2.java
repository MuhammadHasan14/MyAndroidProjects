...
public class ListView_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(ListView_2.this, R.layout.listitem_1,R.id.tv_description, subnames);
        ...
        lv_subnames.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Intent i = new Intent(ListView_2.this, ShowBio_1.class);
